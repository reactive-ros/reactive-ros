...
import org.rhea_core.internal.expressions.WithId;
import org.rhea_core.util.functions.Func1;

/**
 * @author Orestis Melkonian
 */
public class MapExpr<T, R> extends SingleInputExpr implements Transformer<R> {
    ...
    public Transformer<R> clone() {
        return (Transformer<R>) new MapExpr<>(mapper).withID(id);
    }
}
